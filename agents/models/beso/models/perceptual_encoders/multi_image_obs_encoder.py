...
import torchvision
import hydra
from agents.vision.crop_randomizer import CropRandomizer
from agents.common.pytorch_util import dict_apply, replace_submodules
...
class MultiImageObsEncoder(ModuleAttrMixin):
    ...
    def forward(self, obs_dict, lang_cond=None):
        ...
        if self.share_rgb_model:
            ...
            for key in self.rgb_keys:
                ...
                if lang_cond is None:
                    ...
                    feature = self.key_model_map[key](img, lang_cond)
        ...
        return result  # shape-> [B, f1 + f2] -> [B, 64 + 8]
